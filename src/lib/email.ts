...
export async function sendAdminNotification(customer: EmailCustomer, booking: EmailBooking) {
  const adminEmail = process.env.ADMIN_EMAIL || "bookings@industrialcleaning.services";
